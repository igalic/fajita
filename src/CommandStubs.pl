...
&addCmdHook('bugget', ('CODEREF' => 'bugget', 'Identifier' => 'bugget') );
...
&addCmdHook('(HTTPDtype|servertokens)', ('CODEREF' => 'HTTPDtype::HTTPDtype', 'Identifier' => 'HTTPDtype', 'Cmdstats' => 'HTTPDtype', 'Forker' => 1) );
...
&addCmdHook('latest', ('CODEREF' => 'latest', 'Identifier' => 'latest::scan') );
...
&addCmdHook('docsearch', ('CODEREF' => 'ds::ds', 'Identifier' => 'ds', 'Forker' => 1, 'Cmdstats' => 'ds') );
&addCmdHook('svnver', ('CODEREF' => 'svnver', 'Identifier' => 'svnver') );
